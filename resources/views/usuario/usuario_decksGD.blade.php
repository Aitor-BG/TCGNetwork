<x-app-layout>
    ...
    <head>
        ...
        <title>Gundam Card Game</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" />
    </head>

    <body>
        <div class="container mt-5">
            <h1 class="text-center mb-4">Gundam Card Game</h1>
            ...
            <form method="GET" class="row mb-4">
                ...
                <div class="col-md-2">
                    <select name="cardType" class="form-select">
                        ...
                        <option value="UNIT" {{ request('cardType') == 'UNIT' ? 'selected' : '' }}>Unit</option>
                        <option value="PILOT" {{ request('cardType') == 'PILOT' ? 'selected' : '' }}>Pilot</option>
                        <option value="COMMAND" {{ request('cardType') == 'COMMAND' ? 'selected' : '' }}>Command</option>
                        <option value="BASE" {{ request('cardType') == 'BASE' ? 'selected' : '' }}>Base</option>
                        <option value="RESOURCE" {{ request('cardType') == 'RESOURCE' ? 'selected' : '' }}>Resource
                        </option>
                        <option value="EX BASE" {{ request('cardType') == 'EX BASE' ? 'selected' : '' }}>EX Base</option>
                        <option value="EX RESOURCE" {{ request('cardType') == 'EX RESOURCE' ? 'selected' : '' }}>EX
                            Resource</option>
                        <option value="UNIT TOKEN" {{ request('cardType') == 'UNIT TOKEN' ? 'selected' : '' }}>Unit Token
                        </option>
                    </select>
                </div>
                <div class="col-md-2">
                    <select name="color" class="form-select">
                        ...
                        <option value="White" {{ request('color') == 'White' ? 'selected' : '' }}>Blanco</option>
                    </select>
                </div>
                <div class="col-md-3">
            ...
            <div class="row justify-content-center">
                <div class="col-4">
                    <h5>Cartas Seleccionadas: <span id="totalCardsCount">0</span>/50</h5>
        ...
        <script>
            ...
            function updateCounter(button, change, cardName, cardImage, cardType) {
                ...
                if (totalAfterChange > 50) {
                    alert("No puedes añadir más de 50 cartas en total al mazo.");
                    return;
                }
