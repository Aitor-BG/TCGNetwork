<x-app-layout>
    ...
    <head>
        ...
        <title>Dragon Ball: Fusion World</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" />
    </head>

    <body>
        <div class="container mt-5">
            <h1 class="text-center mb-4">Dragon Ball: Fusion World</h1>
            ...
            <form method="GET" class="row mb-4">
                ...
                <div class="col-md-2">
                    <select name="cardType" class="form-select">
                        ...
                        <option value="ENERGY MARKER" {{ request('cardType') == 'ENERGY MARKER' ? 'selected' : '' }}>
                            Energy Marker</option>
                    </select>
                </div>
                <div class="col-md-2">
                                ...
                                <div class="col-md-2 mb-4">
                                    <div class="container text-center">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <span class="counter">0</span>
                                            <button class="btn btn-sm btn-success"
                                                onclick="updateCounter(this, 1, '{{ $dato['code'] }}', '{{ $dato['images']['small'] }}', '{{ $dato['cardType'] }}')"
                                                data-card-name="{{ $dato['name'] . ' - ' . $dato['code'] }}">+</button>
                                        </div>
                                    </div>
                                </div>
